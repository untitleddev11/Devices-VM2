...
function DevicesVM:Init()
    ...
    local Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/untitleddev11/Devices-VM2/refs/heads/main/dependencies/functions.lua"))()
    local Games = game:HttpGet("https://raw.githubusercontent.com/untitleddev11/Devices-VM2/refs/heads/main/dependencies/games.json")
    ...
    if PlaceId == nil then
        setclipboard("https://github.com/untitleddev11/Devices-VM2/blob/main/dependencies/games.json")
